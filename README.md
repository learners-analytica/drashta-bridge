...
Service for Drashta Demo's Data Retrival System, Uses Supabase as Data Source
...
2. Database Schema : Returns Schema of connected database using a view present on the database along with Metadata such as Min, Max, Count and Avg
